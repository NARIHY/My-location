package com.base_spring_boot.com.applications.microservice.test.service;
...
import com.base_spring_boot.com.applications.microservice.test.persistence.model.TestEntity;
import com.base_spring_boot.com.applications.microservice.test.persistence.repository.status.StatusEntityRepository;
import com.base_spring_boot.com.applications.microservice.test.persistence.repository.test.TestEntityRepository;
import com.base_spring_boot.com.applications.microservice.test.persistence.repository.test.criteria.TestEntityCriteriaRepository;
...
public class TestServiceBase extends ServiceBase<TestEntity> {
    ...
    public boolean canCreate() {
        return openIdService.isAdmin() || openIdService.isPropriotary() || openIdService.isClient();
    }
